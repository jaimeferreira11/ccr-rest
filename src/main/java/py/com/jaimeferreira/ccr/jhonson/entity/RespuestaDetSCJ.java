 ...
 */
@Entity
@Table(name = "respuesta_det", schema = "jhonson")
public class RespuestaDetSCJ implements Serializable {

    private static final long serialVersionUID = -662454929291270553L;
