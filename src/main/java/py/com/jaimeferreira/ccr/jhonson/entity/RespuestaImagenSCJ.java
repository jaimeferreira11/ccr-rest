 ...
 */
@Entity
@Table(name = "respuesta_imagen", schema = "jhonson")
public class RespuestaImagenSCJ implements Serializable {

    private static final long serialVersionUID = 3498915881238784778L;
